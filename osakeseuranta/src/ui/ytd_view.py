...
class YTDView:
    """Käyttöliittymä luokka joka vastaa pörssikurssien
         vuoden alkuun verratun kehityksen näyttämisestä"""
    def __init__(self, root, handle_day, handle_year, handle_login, stocks, market, day, index, procent):
        """Luokan konstruktori joka luo uuden näkymän jossa
            näytetään kurssien kehitykset vuoden alkuun verrattuun tilanteeseen.
    ...
    def _initialize(self):
        ...
        for stock in self.stocks:
            ...
            changem  = str(self.market.get_money_change_ytd_with_ticker(stock))
            changep  = str(self.market.get_procent_change_ytd_with_ticker(stock))
